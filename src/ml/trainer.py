...
class AgentTrainer:
    def __init__(self, raw_dir: str, model_dir: str, config: Dict[str, Any]):
    ...
    def train(self) -> Dict[str, list]:
        ...
        # Tipo explícito para satisfacer mypy
        ...
        for epoch in range(self.epochs):
            ...
            avg_v = v_loss / len(val_loader) if len(val_loader) > 0 else 0
            ...
            logger.info(f"Epoch {epoch+1}/{self.epochs} | TL: {avg_t:.4f} | VL: {avg_v:.4f} | VA: {acc:.2%}")
